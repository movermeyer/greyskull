...
class TestBencode(TestCase):
    def test_char(self):
        self.assertEqual(bencode(4),
                         'i4e')
    def test_zero(self):
        self.assertEqual(bencode(0),
                         'i0e')
    def test_negative(self):
        self.assertEqual(bencode(-10),
                         'i-10e')
    def test_long(self):
        self.assertEqual(bencode(12345678901234567890L),
                         'i12345678901234567890e')
    def test_null_string(self):
        self.assertEqual(bencode(''),
                         '0:')
    def test_string(self):
        self.assertEqual(bencode('abc'),
                         '3:abc')
    def test_int(self):
        self.assertEqual(bencode('1234567890'),
                         '10:1234567890')
    def test_empty_list(self):
        self.assertEqual(bencode([]),
                         'le')
    def test_char_list(self):
        self.assertEqual(bencode([1, 2, 3]),
                         'li1ei2ei3ee')
